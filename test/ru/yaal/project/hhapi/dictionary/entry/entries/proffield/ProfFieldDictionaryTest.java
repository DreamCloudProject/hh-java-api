...
public class ProfFieldDictionaryTest {
    ...
    private static final String FIELD_NAME = "ИнФоРмАцИоНнЫе ТеХнОлОгИи, ИнТеРнЕт, ТеЛеКоМ";
    private static final String SPECIALIZATION_ID = "1.221";
    private static final String SPECIALIZATION_NAME = "ПрОгРаМмИрОвАнИе, РаЗрАбОтКа";
